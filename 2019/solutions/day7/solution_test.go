...
func TestCalculateMaximumThrust1(t *testing.T) {
	program := []int{3, 15, 3, 16, 1002, 16, 10, 16, 1, 16, 15, 15, 4, 15, 99, 0, 0}
	output := CalculateMaximumThrust(program)
	expected := 43210

	if output != expected {
		t.Errorf("Expected %d, but got %d instead", expected, output)
	}
}

func TestCalculateMaximumThrust2(t *testing.T) {
...
func TestCalculateMaximumThrust3(t *testing.T) {
...
func TestFeedbackLoop(t *testing.T) {
	...
	output := CalculateThrustWithFeedbackLoop(program)
	expected := 139629729
...
func TestFeedbackLoop2(t *testing.T) {
